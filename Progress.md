...
## 2026-08-10 Zhang Xiaojun Podcast #8、#7、#6 source-first 深读（已完成；已验证，已清理，待提交与推送）
...
- [ ] 选择性提交并推送本批 7 个目标文件，其他用户修改与未跟踪文件不纳入；完成后继续抓取和梳理剩余 #5–#1，#86、#85、#83 继续保留公开逐句接口不可用的证据边界。
