...
- 解读论文、技术文章或项目文档时，默认读者没有读过原文：先独立、完整地讲清问题背景、核心概念、方法流程与作者结论，再进入证据审计、优缺点分析和独立判断；不要把分析结论放在内容讲解之前。
...
- 笔记正文开头先给读者必要的材料定位和背景，然后按原文顺序把问题、人物/概念、论证推进、案例、证据和作者/嘉宾结论讲清楚；完整原文重建之后，才进入结构化抽象、证据审计和独立判断。不能一上来列结论或只给结构化标签，让未读原文的读者自行补全中间过程。不把抓取命令、生成时间、本地路径、材料从哪里来等信息放在头部。
...
- 外部材料笔记的第一交付对象是“没有读过原文的读者”，不是已经知道结论的研究者。
- 访谈/转录必须先交代嘉宾和议题背景，再按时间或主题解释主持人问了什么、嘉宾如何回答、观点怎样转折、用了哪些案例和数字、最后保留了哪些条件；章节表和结论清单不能替代连续叙述。
- 第一遍讲解必须独立成文，读者不打开原文也能理解“发生了什么、为什么这样判断、证据来自哪里、嘉宾自己得出什么结论”。第二遍才可以抽象成机制、证据等级、证伪条件和我的 insight。
- 每次改造既有笔记时，优先补齐原文讲解层，不用新增一篇“修订版”掩盖旧页面；原文重建与独立分析必须有清晰标题和顺序边界。
